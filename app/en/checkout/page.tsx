         ...
         <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
               <Link href="/en" className="inline-block mb-12">
                  ...
                  <div className="text-[9px] uppercase tracking-widest text-[#ec4899] font-bold">Digital Silence</div>
               </Link>
               
               <div className="text-[10px] uppercase tracking-widest text-white/40 mb-3 font-mono">Invoice_Ref: RVB-5509-X</div>
               <h1 className="text-4xl font-semibold mb-6">Local Clients</h1>
               <div className="text-5xl font-light mb-12 border-b border-white/10 pb-8 tracking-tight">
                  €1,790<span className="text-lg text-white/40 ml-2">/ setup fee</span>
               </div>
               ...
               <ul className="space-y-4">
                  <li className="flex gap-4 items-start">
                     ...
                     <div>
                        <div className="font-semibold text-[15px]">Landing Page Setup & Local SEO</div>
                        <div className="text-xs text-white/50 mt-1">Full implementation of decisions, providing clarity.</div>
                     </div>
                  </li>
                  <li className="flex gap-4 items-start">
                     <span className="text-[#8b5cf6] mt-1">✔</span>
                     <div>
                        <div className="font-semibold text-[15px]">Ads Configuration & Conversion Tracking</div>
                        <div className="text-xs text-white/50 mt-1">Flawless API connections to Meta and Google Ads.</div>
                     </div>
                  </li>
                  <li className="flex gap-4 items-start">
                     <span className="text-[#8b5cf6] mt-1">✔</span>
                     <div>
                        <div className="font-semibold text-[15px]">Stable & Predictable Partnership</div>
                        <div className="text-xs text-white/50 mt-1">Total peace of mind. You handle business, we handle code.</div>
                     </div>
                  </li>
               </ul>
            </div>
            ...
            <div className="mt-16 text-xs text-white/30 border-l border-[#8b5cf6]/30 pl-4">
               Payment is end-to-[end] secured. By processing this order you accept the <a href="#" className="underline hover:text-white">Terms & Conditions</a>. Subscription and setup details will be automatically sent to ReverbHub.
            </div>
         </div>

         {/* Right Side: Payment Interface (Checkout) */}
            ...
            <div className="glass-box p-8 lg:p-12 h-full shadow-[0_30px_60px_rgba(0,0,0,0.5)]">
               ...
               <div className="flex gap-4 mb-10 overflow-hidden">
                  ...
                  <button className="flex-1 bg-black border border-white/20 text-white py-4 rounded-xl font-bold flex items-center justify-center gap-2 transition hover:bg-white/10">
                     Pay with <span className="font-extrabold font-serif">Apple</span>
                  </button>
               </div>

               <div className="flex items-center my-8">
                  <div className="flex-1 border-t border-white/10"></div>
                  <div className="px-4 text-[10px] uppercase tracking-widest text-white/30 font-bold">Bank Card</div>
                  <div className="flex-1 border-t border-white/10"></div>
               </div>
               ...
               <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                  ...
                  {/* Email */}
                  <div>
                     <label className="text-xs text-white/70 mb-2 block">Contact Information</label>
                     <input 
                        type="email" 
                  ...
                  <div className="space-y-0">
                     <label className="text-xs text-white/70 mb-2 block mt-6">Payment Details (Stripe Checkout Demo)</label>
                  ...
                  {/* Billing Details */}
                  <div>
                     <label className="text-xs text-white/70 mb-2 block mt-6">Billing Address (Company VAT Number)</label>
                     ...
                     <input 
                        type="text" 
                        placeholder="Company VAT Number / Details" 
                  ...
                  <div className="flex items-center justify-center gap-2 text-xs text-white/40 mt-4">
                     ...
                     Processed by secure payment system
                  </div>
               </form>
            </div>
         </div>
