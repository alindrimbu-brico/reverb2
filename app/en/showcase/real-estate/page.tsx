...
export default function RealEstateShowcaseEN() {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 min-h-screen relative">
         ...
         <div className="md:col-span-5 flex flex-col justify-end p-8 md:p-12 lg:p-20 relative z-20 mix-blend-difference mt-32 md:mt-0">
            <h1 className="text-5xl md:text-7xl font-light tracking-[-0.04em] leading-[1.1] mb-8">
               Architectural<br/>
               <span className="italic font-serif text-[#C9A444]">Sanctuaries.</span>
            </h1>
            <p className="text-sm font-light leading-relaxed max-w-xs text-white/70 mb-12">
               Our portfolio contains strictly residences that redefine the notion of luxury, asymmetrically integrated into the organic landscape.
            </p>
            <div className="flex gap-8 text-[11px] uppercase tracking-[0.2em] font-mono">
               <span className="border-b border-[#C9A444] pb-1 cursor-pointer">Explore the List</span>
               <Link href="/en/showcase" className="opacity-50 hover:opacity-100 transition pb-1 cursor-pointer border-b border-transparent hover:border-white">Return to Matrix</Link>
            </div>
         </div>
