...
export default function CyberSecShowcaseEN() {
  return (
        ...
        <main className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-16 item-center items-center">
           <div>
              ...
              <div className="flex gap-4">
                 ...
                 <Link href="/en/showcase" className="border border-[#00FF41]/30 px-8 py-4 text-xs uppercase hover:bg-white/5 transition flex items-center justify-center">
                    Return to Matrix
                 </Link>
              </div>
           </div>
