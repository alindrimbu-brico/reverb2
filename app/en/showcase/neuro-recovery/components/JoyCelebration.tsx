...
const consciousnessLevels = [
  {
    ...
    title: "Pleasure (Body)",
    desc: "External dependence. Strengthens the ego through slavery to sensory objects. Red/orange vibrations.",
    color: "rgba(239, 68, 68, 0.7)", // red
    accent: "text-red-400",
    border: "border-red-950/60 hover:border-red-500/50",
    bg: "hover:bg-red-950/20",
    vibrationFreq: "alcohol",
    href: "/en/showcase/neuro-recovery/pleasure",
  ...
  },
  {
    ...
    desc: "Competition and ambition. The fear of loss poisons external success. Bright orange waves.",
    ...
    href: "/en/showcase/neuro-recovery/happiness",
  ...
  },
  {
    ...
    title: "Joy (Soul)",
    desc: "Absolute independence. Begins the dissolution of the ego through silence and inner peace. Gold glow.",
    ...
    href: "/en/showcase/neuro-recovery/joy-soul",
  ...
  },
  {
    ...
    bg: "bg-amber-950/10",
    vibrationFreq: "joy",
    href: "/en/showcase/neuro-recovery/ecstasy",
...
function LevelCard({ level, isSelected, onSelect }: LevelCardProps) {
  ...
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.99 }}
      className={`p-6 rounded-2xl border backdrop-blur-md cursor-pointer transition-all duration-500 flex items-start space-x-4 relative overflow-hidden group select-none
...
export default function JoyCelebrationEN() {
  const [activeLevel, setActiveLevel] = useState(consciousnessLevels[2]); // default: Joy (Soul)
      ...
      <div className="max-w-6xl mx-auto w-full relative z-20 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <div className="inline-flex items-center space-x-2 bg-neutral-900 border border-neutral-800 px-4 py-2 rounded-full text-xs font-mono tracking-widest text-amber-500 uppercase self-start">
            ...
            <span>Ras Lila: Interactive Symphony of Mind</span>
          </div>
          ...
          <p className="text-neutral-400 text-lg font-light leading-relaxed">
            The mind heals not by building walls, but by expanding its boundaries. Select a portal on the right to travel, or use the tuner to align.
          </p>
          ...
          <div className="p-8 rounded-3xl bg-neutral-900/40 border border-neutral-800 backdrop-blur-md flex flex-col items-center justify-center text-center space-y-6 relative overflow-hidden">
            <div className="space-y-2">
              <h4 className="text-sm font-mono text-neutral-500 uppercase tracking-widest">
                Interactive Consciousness Tuner
              </h4>
              <p className="text-xs text-neutral-400 max-w-sm">
                Press and hold the sphere below to synchronize your neurochemistry and trigger a transcendence burst.
              </p>
            </div>
                ...
                <AnimatePresence mode="wait">
                  {transcended ? (
                    ...
                    >
                      ...
                      <span className="text-[10px] font-mono uppercase tracking-widest">Aligned</span>
                    </motion.div>
                  ) : (
                    <motion.div
                      key="charge-state"
                    ...
                    >
                      ...
                      <span className="text-[10px] font-mono uppercase tracking-widest text-neutral-400 mt-2">
                        {isCharging ? "Tuning..." : "Hold to Tune"}
                      </span>
            ...
            <AnimatePresence>
              {transcended && (
                ...
                >
                  Consciousness aligned to {activeLevel.title.split(" ")[0]}!
                </motion.p>
              )}
            </AnimatePresence>
          </div>
