...
import { setTheme, playTransitionSound } from "../../../../showcase/neuro-recovery/components/AudioEngine";
...
export default function ArticleLayoutEN({ themeName, children, accentColor }: ArticleLayoutProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 py-24 md:py-32">
        <Link 
          href="/en/showcase/neuro-recovery"
          className={`inline-flex items-center space-x-2 mb-12 transition-colors group ${
            isDark ? "text-neutral-400 hover:text-white" : "text-stone-550 hover:text-stone-900"
          }`}
        >
          <ArrowLeft className="w-5 h-5 transform group-hover:-translate-x-1 transition-transform" />
          <span className="font-mono text-sm tracking-widest uppercase font-semibold">Back to Ecosystem</span>
        </Link>
