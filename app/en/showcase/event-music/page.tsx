...
export default function EventPromoShowcaseEN() {
  return (
    <div className="min-h-screen bg-[#070707] text-white font-sans overflow-hidden selection:bg-[#EC4899] selection:text-white">
      ...
      <div className="relative z-20 flex justify-center pb-20 mt-12">
         <Link href="/en/showcase" className="font-mono text-[10px] uppercase font-bold tracking-[0.2em] border border-white/20 rounded-full px-6 py-3 bg-white/5 hover:bg-white hover:text-black transition backdrop-blur-md">
            [ Return to Matrix ]
         </Link>
      </div>
