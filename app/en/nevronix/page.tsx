...
export const metadata: Metadata = {
  ...
  description: "On-premise hybrid artificial intelligence architecture.",
};

export default function NevronixPartnershipEN() {
  return (
    <div className="bg-[#050505] text-white min-h-screen relative overflow-hidden font-sans selection:bg-[#ccff00] selection:text-[#050505]">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-20 lg:px-10 lg:py-32 min-h-screen flex flex-col justify-center">
        ...
        {/* Nav Helper */}
        <Reveal>
          <Link href="/en" className="inline-flex items-center text-xs font-mono text-white/40 hover:text-[#ccff00] transition-colors mb-20 border border-white/10 hover:border-[#ccff00]/40 rounded-full px-5 py-2 bg-white/5 backdrop-blur-sm">
            ← Back to Reverb.ro
          </Link>
        </Reveal>
          ...
          <div className="lg:col-span-6 flex flex-col items-start gap-8">
            ...
            <Reveal delay={300}>
              <p className="text-xl md:text-2xl text-white/70 font-light leading-relaxed max-w-xl">
                The <strong className="font-semibold text-white">Reverb x Nevronix</strong> partnership brings the future of private AI to Romania. 
                Stop renting intelligence from tech giants. Own it locally.
              </p>
            </Reveal>
          ...
          <Reveal delay={600}>
            <div className="group h-full border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition-all duration-500 hover:border-[#ccff00]/30 hover:bg-[#ccff00]/5">
              ...
              <p className="text-white/60 text-sm leading-relaxed font-light">
                Raw processing architecture powered by Nevronix hubs. Isolated performance and critical speed for advanced artificial intelligence tasks, without API limitations.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal delay={700}>
            <div className="group h-full border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition-all duration-500 hover:border-[#ccff00]/30 hover:bg-[#ccff00]/5">
              ...
              <p className="text-white/70 font-mono text-[11px] uppercase tracking-widest mb-6 border-b border-white/5 pb-4 group-hover:text-[#ccff00]/90 transition-colors">
                Private LLMs &amp; Fine-tuning
              </p>
              <p className="text-white/60 text-sm leading-relaxed font-light">
                Reverb language modules align with the Nevronix core. We build digital brains trained on your company's internal corpus, fully disconnected from third-party networks.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal delay={800}>
            <div className="group h-full border border-[#ccff00]/30 bg-[#ccff00]/5 p-8 backdrop-blur-sm transition-all duration-500 shadow-[0_0_30px_rgba(204,255,0,0.05)] hover:shadow-[0_0_50px_rgba(204,255,0,0.1)] hover:bg-[#ccff00]/10">
              ...
              <p className="text-white/70 text-sm leading-relaxed font-light">
                The only way your company data remains exclusive property. Zero telemetry. The absolute guarantee that algorithm-built strategic decisions will not feed Big Tech giants.
              </p>
            </div>
          </Reveal>
        </div>
