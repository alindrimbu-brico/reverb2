...
export default function ClientPortalEN() {
  return (
    <div 
    ...
    >
      ...
      {/* Minimal Horizontal Navbar for Portal */}
      <header className="absolute top-0 w-full p-8 z-20 flex justify-between items-center">
        <Link href="/en" className="text-xl font-bold tracking-[-0.04em] flex items-center gap-2 hover:opacity-70 transition">
           <div className="w-1.5 h-1.5 bg-[#8b5cf6] rounded-full animate-pulse"></div>
           Reverb<span className="text-[#8b5cf6]">Hub</span>
        </Link>
        <Link href="/en" className="text-[10px] uppercase font-bold tracking-[0.2em] text-white/50 hover:text-white transition border-b border-transparent hover:border-white pb-1">
           Back to Site
        </Link>
      </header>
      ...
      <main className="relative z-10 w-full max-w-md p-6 h-full flex flex-col justify-center animate-[slide-in-top_1s_ease-out]">
        ...
        <div className="text-center mb-10">
           <h1 className="text-3xl lg:text-4xl font-medium tracking-tight mb-3">Client Space Login</h1>
           <p className="text-sm text-white/60 font-light">Monitor your project progress, active campaigns or monthly invoices.</p>
        </div>
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-xl rounded-[2rem] p-8 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
           ...
           <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
              ...
              <div>
                 <div className="flex justify-between items-end mb-2 pl-2 pr-2">
                    ...
                    <a href="#" className="text-[10px] text-white/40 hover:text-[#ec4899] transition cursor-pointer">Reset Password</a>
                 </div>
                 <input 
                    type="password" 
                    placeholder="••••••••••••" 
           ...
           <div className="flex items-center my-8">
              ...
              <div className="px-4 text-[10px] uppercase tracking-widest text-white/40 font-bold">Or Secure Authentication</div>
              <div className="flex-1 border-t border-white/10"></div>
           </div>
           ...
           <div className="mt-8 text-center text-xs text-white/40">
              Secured by the internal Reverb platform. Unauthorized access is logged.
           </div>
