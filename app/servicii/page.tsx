...
const faq = [
  ...
  },
  {
    ...
    a: "Da. Nu dispărem după lansare. Consultanța continuă și optimizarea fac parte din filosofia noastră — parteneriat, nu tranzacție.",
  },
  {
                ...
                >
                  <div className="grid gap-10 lg:grid-cols-[1fr_1fr]">
                    <div>
                      ...
                      <p className="mt-2 text-sm font-medium text-[#1d2731]/50">{s.context}</p>
