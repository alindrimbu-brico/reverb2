...
export default function XiaolongShowcase() {
  const [markup] = useState(1.30); // +30% markup cerut
    ...
    <div className="bg-[#fcfdfc] text-[#1c2a21] font-sans selection:bg-[#208b53] selection:text-white min-h-screen">
      ...
      <nav className="sticky top-0 z-50 w-full border-b border-[#208b53]/10 bg-white/90 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
          ...
          <Link href="/" className="text-[10px] font-bold uppercase tracking-widest border-b border-[#1c2a21] pb-1 hover:text-[#208b53] hover:border-[#208b53]">
            Înapoi la Reverb
          </Link>
        </div>
      </nav>
      ...
      {/* ── Products & B2B Pricing (+25% Module) ── */}
