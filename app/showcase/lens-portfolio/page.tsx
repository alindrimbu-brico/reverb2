...
export default function LensPortfolioShowcase() {
  return (
      ...
      <div className="flex-1 border-[1px] border-black/20 relative flex flex-col justify-between p-6 md:p-12 overflow-hidden bg-white/50">
         ...
         <footer className="flex justify-between items-end font-mono text-[10px] uppercase tracking-widest z-10">
            <div className="flex flex-col gap-2">
               <h1 className="text-3xl font-serif italic lowercase tracking-tight">Focus. Captură. Timp.</h1>
               <div className="opacity-50 max-w-sm mt-4 font-sans leading-relaxed lowercase">
                  portofoliu digital pentru studiourile care înțeleg că o fotografie bună este o secvență tăiată din realitate infinită.
               </div>
            </div>
            <a href="/showcase" className="border-b border-black pb-1 hover:opacity-50 transition hidden md:block">
               ← Return to Index
            </a>
         </footer>
