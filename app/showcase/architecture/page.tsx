        ...
        <div className="md:col-span-3 lg:col-span-2 border-r border-[#111111]/20 p-8 flex flex-col justify-between mix-blend-multiply bg-[#EAEAEA]">
           <div>
              ...
              <ul className="space-y-6 text-sm font-semibold tracking-tight">
                 <li><a href="#" className="flex items-center gap-4 hover:opacity-50 transition"><span className="w-4 h-px bg-black"></span> Proiecte</a></li>
                 <li><a href="#" className="flex items-center gap-4 opacity-50 hover:opacity-100 transition"><span className="w-0 hover:w-4 transition-all h-px bg-black"></span> Manifest</a></li>
                 <li><a href="#" className="flex items-center gap-4 opacity-50 hover:opacity-100 transition"><span className="w-0 hover:w-4 transition-all h-px bg-black"></span> Despre Noi</a></li>
              </ul>
           </div>
           ...
           <div className="font-mono text-[9px] uppercase tracking-[0.1em] text-[#111111]/50 space-y-2">
              ...
              <Link href="/showcase" className="block mt-4 pt-4 border-t border-[#111111]/20 text-[#111111] hover:underline">
                 ← Showcase Matrix
              </Link>
           </div>
        </div>
           ...
           <div className="p-8 md:p-12 lg:p-20 relative z-10 border-b border-[#111111]/20 h-auto md:h-2/5 flex flex-col justify-end">
             <div className="overflow-hidden">
               <h1 className="text-[12vw] md:text-[8vw] lg:text-[7vw] font-medium leading-[0.8] tracking-[-0.05em] uppercase animate-[scaleIn_1s_cubic-bezier(0.16,1,0.3,1)_forwards]">
                  Forma Urmează<br/>
                  <span className="text-[#111111]/40">Materia.</span>
               </h1>
             </div>
           </div>
           ...
           <div className="flex-1 grid grid-cols-1 md:grid-cols-2 relative z-10 bg-[#EAEAEA]">
              <div className="p-8 md:p-12 lg:p-20 flex flex-col justify-between border-b md:border-b-0 md:border-r border-[#111111]/20">
                 <div>
                    ...
                    <h3 className="text-2xl font-semibold mb-4 tracking-[-0.02em]">Oda Betonului Brut</h3>
                    <p className="text-[#111111]/70 leading-relaxed font-sans max-w-sm">
                       Arhitectura trebuie să supraviețuiască trendurilor. Explorăm spațialitatea curată, eliminând decorațiunile inutile. Doar lumină, proporții și piatră cubică.
                    </p>
                 </div>
                 <div className="mt-12 flex justify-between font-mono text-[10px] uppercase tracking-[0.2em] font-bold">
                    <span>Proiect: Casa A-01</span>
                    <span>An: 2024</span>
                 </div>
              </div>
