    ...
    >
      <div className="max-w-4xl mx-auto w-full">
        ...
        >
          <div className="flex flex-wrap justify-center gap-4 items-center mb-2">
            <div className="inline-flex items-center justify-center space-x-2 text-neutral-400">
              ...
              <span className="uppercase tracking-widest text-xs font-mono">Legea Compensării</span>
            </div>
          </div>
        ...
        <div className="bg-neutral-900/40 border border-neutral-800 rounded-3xl p-8 backdrop-blur-md">
          {/* Controls */}
          <div className="mb-12">
            <label className="flex justify-between text-sm text-neutral-400 mb-4 font-mono">
              <span>Homeostazie (Repaus)</span>
              <span>Suprastimulare</span>
            </label>
            <input
              type="range"
              min="0"
          ...
          <div className="relative h-64 border-l border-b border-neutral-700 flex items-end justify-center pb-8 pt-8">
            ...
            <div className="absolute top-1/2 left-0 w-full h-px bg-neutral-600 border-dashed border-t border-neutral-500 z-0">
              <span className="absolute -top-6 left-2 text-xs text-neutral-500 font-mono">Linia de Bază (Homeostazie)</span>
            </div>

            {/* Process A Bar */}
            <div className="relative flex flex-col items-center w-1/3 z-10">
              <span className="text-blue-400 font-bold mb-2 text-sm opacity-80">Procesul A</span>
              <motion.div
            ...
            <div className="relative flex flex-col items-center w-1/3 z-10">
              ...
              />
              <span className="text-red-400 font-bold mt-2 text-sm opacity-80 absolute" style={{ top: `calc(50% + ${processB > 0 ? processB : 4}px + 8px)` }}>Procesul B</span>
            </div>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-2">
              <h4 className="text-blue-400 font-medium">Procesul A: Falsul Paradis</h4>
              <p className="text-sm text-neutral-400 leading-relaxed">
                Reprezintă efectul imediat al substanței—vârful de dopamină, anestezia emoțională, calmul fals. Este artificial și temporar.
              </p>
            </div>
            <div className="space-y-2">
              <h4 className="text-red-400 font-medium">Procesul B: Prețul Plătit</h4>
              <p className="text-sm text-neutral-400 leading-relaxed">
                Creierul luptă cu disperare să revină la echilibru, pompând neurochimicale "anti-drog". Toleranța înseamnă că acest efort de contracarare a devenit mai puternic. Când substanța dispare, Procesul B rămâne activ, lăsând un abis de anxietate și disforie (sevrajul).
              </p>
            </div>
          </div>
