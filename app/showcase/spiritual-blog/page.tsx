...
const articles = [
  ...
  { id: "mel-gibson", title: "Sacred Cinema: Pasiunea ca Calea Spiritualei", category: "Mel Gibson's Vision", excerpt: "Cum arta divine – în special filmul – transmuta suferința în înțelepciune. Iisus Hristos respiră în fiecare cadru.", color: "#DC143C", readTime: "19 min", icon: "🎬", fullContent: "Mel Gibson a creat 'Pasiunea lui Iisus Hristos' (2004) complet în Aramaică și Latină – filmul nu era o producție Hollywood, ci o dedicație mistică. Suferința Cerului transcrisă pe peliculă, transmutând cuvintele în Lumină. Pentru Gibson, cinematografia este instrument de transformare spirituală, cu fiecare cadru vibrând cu intenție sacră. Trilogia sa (Pasiunea, Apocalypto, Hacksaw Ridge) explore cum sufletul curat câștigă: în Pasiune Iisus mântuiește, în Apocalypto copilul cu inimă curată supraviețuiește, în Hacksaw Ridge bărbatul fără armă este mai puternic decât războinicii. Filmul următor, 'The Passion of the Christ: Resurrection', va arăta cum Morțile nu poate stăpâni Iubirea Veșnică. Gibson crede: 'Nu poți vindeca ceva ce nu ești dispus să simți complet.' Arta din suferință devine mântuire pentru alții." },
];
