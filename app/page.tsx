...
export const metadata: Metadata = {
  title: "Reverb — Structură, Claritate, Eficiență",
  description:
...
export default function HomePage() {
  return (
    <div className="bg-[#f5f1ea] text-[#1d2731] font-sans selection:bg-[#1d2731] selection:text-[#f5f1ea] overflow-x-hidden">
      ...
      {/* ── Keyframes for subtle smooth interactions (rată mărită) ── */}
      <style>{`
        /* Mișcarea elementelor de fundal (100%) */
        @keyframes float-a {
        ...
        /* Mișcarea Typography-ului (70% rezistență / Paralaxă) */
        @keyframes float-text-a {
          0%, 100% { transform: translateY(0); }
          50% { transform: translateY(-11px); }
        }
        @keyframes float-text-b {
          0%, 100% { transform: translateY(0); }
          50% { transform: translateY(-14px); }
        }
        @keyframes float-text-c {
          0%, 100% { transform: translateY(0); }
          50% { transform: translateY(10px); }
        }
        
        
        .tab-blur-group:hover > div:not(:hover) {
          filter: blur(5px);
          opacity: 0.3;
        ...
        .tab-blur-item:hover {
          ...
          z-index: 10;
          box-shadow: 0 30px 60px rgba(29, 39, 49, 0.05);
           ...
           <div className="lg:col-span-12 w-full text-center flex flex-col items-center">
             ...
             <Reveal delay={80}>
               <h1 className="max-w-5xl text-5xl md:text-7xl lg:text-8xl font-light tracking-[-0.04em] leading-[0.98] text-[#1d2731]">
                 Omul împăcat știe <br className="hidden md:block"/> exact ce are de făcut.
               </h1>
             </Reveal>
             ...
             <Reveal delay={240}>
               <div className="mt-12 flex flex-col gap-4 sm:flex-row w-full justify-center">
                 <Link
                   href="/contact"
                   className="inline-flex items-center justify-center rounded-full bg-[#1d2731] px-10 py-5 text-sm font-semibold text-[#f5f1ea] transition-all hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(29,39,49,0.2)]"
                 >
                   Obține claritatea afacerii tale →
                 </Link>
                 <Link
                   href="/showcase"
                   className="hidden sm:inline-flex items-center justify-center rounded-full border border-[#1d2731]/20 bg-white/30 backdrop-blur-sm px-10 py-5 text-sm font-medium text-[#1d2731]/80 hover:bg-white/80 hover:border-[#1d2731]/40 transition-all duration-300 hover:-translate-y-1"
                 >
                   Portofoliu Structurat (15 Modele)
                 </Link>
               </div>
             </Reveal>
           </div>
             ...
             <div className="lg:col-span-7 grid gap-6 tab-blur-group">
               {[
                 ...
                 <Reveal key={box.nr} delay={i * 80}>
                   <div className="tab-blur-item p-8 md:p-10 border border-[#1d2731]/10 bg-white rounded-2xl cursor-default relative overflow-hidden">
