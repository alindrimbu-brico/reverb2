...
import { ArrowLeft, Globe, ChevronRight, TrendingDown, Users, Zap, Play, Square } from "lucide-react";
...
const AUDIO_LAYERS = [
  { freq: 73.4, type: "sine" as OscillatorType, gain: 0.05, lfoRate: 0.08 },
  { freq: 146.8, type: "sine" as OscillatorType, gain: 0.02, lfoRate: 0.13 },
];
...
function RobotImageHero({ name, company, accent }: { name: string; company: string; accent: string }) {
  return (
    <div
      className="relative w-full h-44 md:h-56 rounded-2xl overflow-hidden mb-6"
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-2">
        ...
        <div className="text-3xl md:text-4xl font-black tracking-tight" style={{ color: accent, textShadow: `0 0 40px ${accent}35` }}>{name}</div>
      </div>
      <div className="absolute bottom-0 left-0 right-0 h-10" style={{ background: "linear-gradient(to top, #080810, transparent)" }} />
    </div>
  );
}
  ...
  return (
    <div className="min-h-screen bg-[#080810] text-white">
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <motion.div custom={0} variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-60px" }}>
            <RobotImageHero name={tx.unitreeG1.title} company="Unitree Robotics" accent="#FFE600" />
      ...
      <section className="py-20 px-6 bg-[#0a0a14]">
        <div className="max-w-6xl mx-auto">
          <motion.div custom={0} variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-60px" }}>
            <RobotImageHero name={tx.unitreeR1.title} company="Unitree Robotics" accent="#00E5FF" />
            <div className="flex items-center gap-3 mb-3">
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <motion.div custom={0} variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-60px" }}>
            <RobotImageHero name={tx.noetix.title} company="Noetix Robotics" accent="#FFE600" />
            <div className="flex items-center gap-3 mb-3">
              <div className="w-8 h-8 rounded-lg bg-[#FFE600]/10 border border-[#FFE600]/25 flex items-center justify-center">
